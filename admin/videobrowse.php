...
<title>Valdosta State University Video Project | Browse Database Page</title>
...
<div id= "outer">
	...
	<div id="menu">
		  <h1><u>&nbsp; &nbsp;Valdosta State University Video Project | Browse Database Page </u></h1>
	  	<ul>
			<li class="first"><a href= "../main.php">Student Volunteer Home Page</a></li>
			<li><a href="admin.php">Student Volunteer Admin Page</a></li>
		</ul>
	</div>
	<div id= "content">
	  <div id= "primaryContentContainer">
	  <h1><strong>Valdosta State University Video Project | Browse Database Page</strong></h1>
